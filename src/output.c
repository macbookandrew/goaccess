...
print_html_header (FILE * fp, char *now)
{
  ...
  "}"
  ".pure-table th:not(.sorttable_sorted):not(.sorttable_sorted_reverse):not(.sorttable_nosort):after {"
  "    content: \"25B4\25BE\""
  "}"
  ".pure-table tbody th {"
